...
public class TextMessageUpdateExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void TextMessageUpdateException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var messageId = "1";
        var reason = "Test reason";
        TextMessageUpdateException exception = new(messageId, reason);
