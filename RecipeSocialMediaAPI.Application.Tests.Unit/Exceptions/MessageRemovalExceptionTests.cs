...
public class MessageRemovalExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void MessageRemovalException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var messageId = "1";
        MessageRemovalException exception = new(messageId);
