...
public class CorruptedMessageExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void CorruptedMessageException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var message = "Test message";
        CorruptedMessageException exception = new(message);
