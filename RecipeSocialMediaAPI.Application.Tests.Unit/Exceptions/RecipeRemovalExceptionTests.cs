...
public class RecipeRemovalExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void RecipeRemovalException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var recipeId = "1";
        RecipeRemovalException exception = new(recipeId);
