...
public class AttemptedToSendMessageToBlockedConnectionExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void AttemptedToSendMessageToBlockedConnectionException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var message = "Test message";
        AttemptedToSendMessageToBlockedConnectionException exception = new(message);
