...
public class CloudinarySignatureGenerationExceptionTests
{
    [Fact]
    [Trait(Traits.DOMAIN, Traits.Domains.INFRASTRUCTURE)]
    [Trait(Traits.MODULE, Traits.Modules.APPLICATION)]
    public void CloudinarySignatureGenerationException_IsCorrectlySerializedAndDeserialized()
    {
        // Given
        var message = "Test message";
        CloudinarySignatureGenerationException exception = new(message);
